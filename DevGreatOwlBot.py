...
async def on_message(message):
    ...
    #Help response
    if message.content.startswith('god!help'):
        em = discord.Embed(
    ...
    #Coriolis response
    if message.content.startswith('god!coriolis'):
        em = discord.Embed(
    ...
    #Fuel Rats response
    if message.content.startswith('god!fuelrats'):
        em = discord.Embed(
            title='The Fuel Rats',
    ...
    #INARA response
    if message.content.startswith('god!inara'):
        em = discord.Embed(
    ...
    #EDDB response
    if message.content.startswith('god!eddb'):
        em = discord.Embed(
    ...
    #EDRefCard response
    if message.content.startswith('god!edrefcard'):
        em = discord.Embed(
            title='EDRefCard',
    ...
    #EDSM response
    if message.content.startswith('god!edsm'):
        em = discord.Embed(
